...
**各言語20語の単語リスト**を中心に、文法解説と原文記事を加えた3画面のWebアプリ。
ブラウザで開くだけで動きます。
...
アプリは3画面だけです。上で**言語**を、下で**タブ**を選びます。設定はブラウザに保存されます。

### 🗂 単語（起動時の画面）

各言語**20語ずつ、合計80語**。今週の記事から、学習価値の高い単語と熟語を選んでいます。
記事を読む時間がなくても、ここだけで完結します。
...
- **🔊** で単語の発音、例文の右の 🔊 で例文の発音
- **✓** で「覚えた」印。右上に `3 / 20` と進み具合が出ます
- **🙈 意味を隠す** で全カードの意味がぼかされ、**カードを押すとその1枚だけ**開きます
- **🔊 20語を続けて聞く** で20語を通して再生
- **⚙︎ 音声** で速度・リピート・文の間・言語ごとの声

中国語は漢字1字ごとにピンインのルビが付きます。

### 📐 文法

その言語の文法解説を、記事ごと・テーマごとにまとめてあります。
折りたたみを開くと、なぜその形になるのか、他の形とどう違うのかまで書いてあります。例文には音声ボタンつき。
